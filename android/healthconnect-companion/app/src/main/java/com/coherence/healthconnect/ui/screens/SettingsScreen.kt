...
import com.coherence.healthconnect.sync.HistoricalSyncWorker
      ...
      item {
        Card(
          ...
          Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
            ...
            Text("Version ${com.coherence.healthconnect.BuildConfig.VERSION_NAME}", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
          }
        }
      }
