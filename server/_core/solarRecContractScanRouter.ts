  ...
  rescanSingleContract: requirePermission("contract-scrape-manager", "edit")
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await insertContractScanResult({
        ...
        crgaNoticePresent: extraction.crgaNoticePresent ?? null,
        crgaNoticeMisplaced: extraction.crgaNoticeMisplaced ?? null,
        crgaNoticeFlag: extraction.crgaNoticeFlag ?? null,
