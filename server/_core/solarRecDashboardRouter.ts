  ...
  getDatasetSummariesAll: requirePermission("solar-rec-dashboard", "read")
    .query(async ({ ctx }) => {
      ...
      const ALL_DATASET_KEYS = [
        // Row-backed (10 datasets — 7 from data-flow series + 3 added
        // by Task 5.12 PRs 1–3 (generatorDetails, abpCsgSystemMapping,
        // abpProjectApplicationRows) 2026-04-27).
        "solarApplications",
        "abpReport",
        "generationEntry",
        ...
        // Non-row-backed (chunked-CSV only — Task 5.12 PRs 4–12 will
        // migrate the remaining 9 to srDs* row tables).
        "convertedReads",
        "abpQuickbooksRows",
      ...
      return {
        ...
        _runnerVersion: "task-5.12-pr3" as const,
        scopeId,
        summaries,
      };
    }),
