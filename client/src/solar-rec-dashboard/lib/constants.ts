...
// PR B2: contract-type constants now live in
// `@shared/solarRecStanding` so the server aggregators + the client
// worker share a single source of truth. Re-exported here so legacy
// imports (`@/solar-rec-dashboard/lib/constants`) keep resolving.
export {
