...
import {
  ...
  parseTabularFile,
  findHeaderRowIndex,
  readByNormalizedHeader,
  findHeaderByKeywords,
  findHeaderByKeywordsExcluding,
  findHeaderByAliases,
} from "./csvParsing";

export type { ParsedTabularData } from "./csvParsing";
export { parseTabularFile } from "./csvParsing";
