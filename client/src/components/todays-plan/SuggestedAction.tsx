...
export function SuggestedAction({ description, onAddToPlan, added = false }: SuggestedActionProps) {
  return (
    <div className="flex items-start justify-between gap-3 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5">
      ...
      <Button size="sm" variant="outline" className="shrink-0" onClick={onAddToPlan} disabled={added}>
