...
export default function SunpowerReadings() {
  ...
  } = trpc.solarReadings.summary.useQuery();

  const {
    data: readings,
    isLoading: listLoading,
    refetch,
  } = trpc.solarReadings.list.useQuery(
    {
      limit: 200,
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-left text-xs text-muted-foreground uppercase tracking-wider">
                    ...
                    <th className="pb-2 pr-4 font-medium text-right">Lifetime kWh</th>
