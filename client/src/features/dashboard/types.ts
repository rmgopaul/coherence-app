...
export type DockItem = RouterOutputs["dock"]["list"][number];
export type ClockifyStatus = RouterOutputs["clockify"]["getStatus"];
export type ClockifyCurrentEntry = RouterOutputs["clockify"]["getCurrentEntry"];
export type ClockifyRecentEntry = RouterOutputs["clockify"]["getRecentEntries"][number];
export type WeeklyReview = RouterOutputs["weeklyReview"]["getLatest"];
...
export type DriveFile = RouterOutputs["google"]["getDriveFiles"][number];
