...
export default function SolarRecDashboard() {
  ...
  // annualContractVintageRows, annualVintageRows, annualContractSummaryRows, annualPortfolioSummary,
  // contractDeliveryRows, contractSummaryRows, visibleContractSummaryRows, visibleContractDeliveryRows,
  // visibleAnnualContractVintageRows, visibleAnnualContractSummaryRows + their pagination locals
