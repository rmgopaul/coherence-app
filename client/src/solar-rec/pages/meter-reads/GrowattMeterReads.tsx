/**
 * Task 5.4 vendor 8/16 — Growatt (OpenAPI) meter-reads on solar-rec.
 *
 * Team credential stores `{username, password, baseUrl}`. Lists plants
...
export default function GrowattMeterReads() {
  ...
  const listPlantsQuery = trpc.growatt.listPlants.useQuery(undefined, {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      <div>
        <h1 className="text-xl font-semibold">Growatt OpenAPI</h1>
        <p className="text-sm text-muted-foreground">
          Run meter reads against the team&rsquo;s Growatt credential. Manage
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <CardDescription>
                Discover plants on the connected Growatt account.
              </CardDescription>
            </div>
            <Button
              variant="outline"
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-1">
              <Label htmlFor="growatt-plant-id">Plant ID</Label>
              <Input
                id="growatt-plant-id"
                value={plantId}
            ...
            <div className="space-y-1">
              <Label htmlFor="growatt-anchor-date">
                Anchor date (optional)
              </Label>
              <Input
                id="growatt-anchor-date"
                type="date"
                value={anchorDate}
