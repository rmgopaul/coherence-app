                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      <CardTitle className="text-base text-rose-900">
                        Schedule Conflicts ({formatNumber(deliveryTrackerData.conflicts.length)})
                      </CardTitle>
                      <CardDescription className="text-rose-800">
                        These tracking IDs appear in both REC Delivery Schedules and Delivery Schedule (Obligations)
                        with differing values. The canonical CSV (REC Delivery Schedules) is winning — review and
                        reconcile if needed.
                      </CardDescription>
                    </div>
                    <Button
